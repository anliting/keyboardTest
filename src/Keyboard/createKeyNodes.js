...
function createKeyNodes(){
    return{
        ...
        'Control':{
            ...
            2:dom.div({className:'key wide125 ctrl'},'CTRL'),
        },
        'Meta':{
            1:dom.div({className:'key wide125 meta'},'META'),
            2:dom.div({className:'key wide125 meta'},'META'),
        },
        'Alt':{
            1:dom.div({className:'key wide125 alt'},'ALT'),
            2:dom.div({className:'key wide125 alt'},'ALT'),
        },
        ' ':{
            0:dom.div({className:'key space'},'SPACE'),
        },
        'ContextMenu':{
